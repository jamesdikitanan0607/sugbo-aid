...
public final class ActivitySimpleSplashBinding implements ViewBinding {
  ...
  private ActivitySimpleSplashBinding(@NonNull RelativeLayout rootView,
      @NonNull MaterialButton btnLogin, @NonNull MaterialButton btnSignup,
      @NonNull ImageView ivLogo, @NonNull LinearLayout llAuthButtons,
  ...
  public static ActivitySimpleSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySimpleSplashBinding((RelativeLayout) rootView, btnLogin, btnSignup, ivLogo,
